  ...
  return (
    <footer className={`footer ${isRTL ? 'rtl' : ''}`}>
      ...
      <div className="footer-container">
        ...
        >
          <a href="https://www.instagram.com/vexa__ai" target="_blank" rel="noopener noreferrer" className="social-icon">
          ...
          <a href="https://www.facebook.com/people/VexaAi/61583050565770/?locale=fr_FR" target="_blank" rel="noopener noreferrer" className="social-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.linkedin.com/company/vexaia/" target="_blank" rel="noopener noreferrer" className="social-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
